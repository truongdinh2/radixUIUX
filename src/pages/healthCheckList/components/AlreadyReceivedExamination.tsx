...
export const AlreadyReceivedExamination = () => {
  const { t } = useTranslation('healthChecklist');
  return (
    <div className="sm:container sm:px-10 bg-white pt-5">
      <h1 className="text-lg bg-black700 text-white border-black900 text-center py-2 font-semibold tracking-tight">
        {t('Already received a medical examination')}
      </h1>
      <div className="p-3 sm:px-0 sm:py-1.5 bg-black100 relative">
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-col sm:p-3.5 sm:px-5 gap-2 relative items-center">
            <div className="flex flex-col bg-white p-5 sm:p-3.5 sm:px-5 relative w-full overflow-hidden items-start">
              <div
                style={{
                  marginTop: '-44px',
                  marginRight: '-32px',
                }}
                className="absolute flex items-start flex-col text-white bg-black900 center rotate-35 w-[102px] h-[80px] right-0 top-0"
              >
                <span
              ...
              <div className="gap-y-4 flex flex-col items-start font-medium text-black900">
                ...
                <p className="flex flex-col sm:flex-row">
                  ...
                  <p className="flex flex-col flex-1">2032/12/01 受付時間08:35</p>
                </p>
                <p className="flex flex-col sm:flex-row">
                  <span className="font-normal w-[115px]">
