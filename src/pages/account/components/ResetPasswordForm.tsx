...
interface ResetPasswordForm extends React.HTMLAttributes<HTMLDivElement> {
  onSubmitHandler: (data: IFormInput) => void;
}

export function ResetPasswordForm({ className, onSubmitHandler, ...props }: ResetPasswordForm) {
  ...
  return (
    ...
    >
      <p className="fontsize-l font-medium text-black900">
        {t('Login completed')}
        <p>{t('Please change to this password (any password)')}</p>
      </p>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-4">
          ...
          <p className="fontsize-s font-normal text-black700">
            ...
            <p>{t('Requires at least 8 characters')}</p>
          </p>
          <div className="grid">
